...
class YTDemo implements ActionListener
  {  
   JLabel displayLabel;
   JButton nextButton;
   JButton prevButton;
   ...
   YTDemo()
     {  
      try
        {
         YTResorce = ResourceBundle.getBundle("resources.YTResources",Locale.getDefault());
        }
      ...
      JFrame jfrm = new JFrame(YTResorce.getString("YTDemo"));  
      ...
      prevButton = new JButton(YTResorce.getString("Prev"));
      prevButton.setActionCommand("Prev");
      buttonPanel.add(prevButton);
      prevButton.addActionListener(this);
      
      nextButton = new JButton(YTResorce.getString("Next"));
   ...
   private void nextUIState() throws Exception
     {
      ...
      if (fv.getFactSlot("state").toString().equals("final"))
        { 
         ...
         nextButton.setText(YTResorce.getString("Restart")); 
         prevButton.setVisible(true);
        }
      else if (fv.getFactSlot("state").toString().equals("initial"))
        {
         nextButton.setActionCommand("Next");
         nextButton.setText(YTResorce.getString("Next"));
      ...
      for (int i = 0; i < pv.size(); i++) 
        {
         ...
         if (bv.toString().equals(selected))
            { rButton = new JRadioButton(YTResorce.getString(bv.toString()),true); }
         else
            { rButton = new JRadioButton(YTResorce.getString(bv.toString()),false); }
      ...
      String theText = YTResorce.getString(fv.getFactSlot("display").symbolValue());
