...
;;;======================================================
;;;
;;;     This expert system helps with choosing a YouTube channel.
;;;
...
(defrule Breakingnyc ""
	...
	(assert (UI-state (display BreakingnysResult)
						(state final))))
...
(defrule Alanvlogs ""
	(logical (girls-or-boys-only-fiveawesomes Boys))
...
(defrule Owlssayhoot ""
	(logical (girls-or-boys-only-fiveawesomes Girls))
